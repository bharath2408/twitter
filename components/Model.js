      ...
      <Dialog as="div" className="fixed z-50 inset-0 pt-8" onClose={setIsOpen}>
        <div className="flex items-start justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            <div className="flex items-center px-1.2 py-2 border-b border-gray-700">
                <div className="hoverAnimations w-9 h-9 flex items-center justify-center xl:px-0"
                    ...
                    <div className="text-[#6e767d] flex gap-x-3 relative">
                        ...
                        <div>
                            <div className="inline-block group">
                                <h4 className="font-bold inline-block text-[15px] sm:text-base text-[#d9d9d9]">{post?.username}</h4>
